...
function installStyles() {
  ...
  style.textContent = `
    ...
    .workflowx-csx-editor{min-width:0;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr)}.workflowx-csx-field{display:grid;grid-template-columns:80px minmax(0,1fr);gap:9px;align-items:center;padding-bottom:10px}.workflowx-csx-input{width:100%;min-height:34px;box-sizing:border-box;border:1px solid var(--border-color,#465665);border-radius:6px;padding:6px 9px;background:var(--comfy-input-bg,#222a32);color:var(--fg-color,#eef3f8)}.workflowx-csx-mode-list{min-height:0;overflow:auto;display:grid;align-content:start;gap:1px;border:1px solid var(--border-color,#35414c);background:var(--border-color,#35414c)}.workflowx-csx-mode-row{display:grid;grid-template-columns:minmax(160px,1fr) minmax(340px,1.7fr);gap:10px;align-items:center;min-height:44px;padding:6px 9px;background:var(--comfy-menu-bg,#151a20)}.workflowx-csx-empty{padding:24px;color:var(--descrip-text,#9aa8b6);text-align:center}
